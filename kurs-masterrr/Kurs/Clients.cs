    ...
    public partial class Clients : Form
    {
        ...
        private void Clients_Load(object sender, EventArgs e)
        {
            if (!File.Exists(@"D:\clients1.sqlite"))
            {
                ...
                SQLiteCommand sc = new SQLiteCommand("create table Clients(id INTEGER PIMARY KEY, name TEXT, birthday TEXT, sex TEXT, child TEXT, phone TEXT, email TEXT, info TEXT )", sql);
        ...
        private void button_edit_client_Click(object sender, EventArgs e)
        {
            addClient ac = new addClient();
